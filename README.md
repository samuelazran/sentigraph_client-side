# sentigraph - social media sentiment analisys

This project structure is based on Angular Seed.
...
```
git clone https://github.com/samuelazran/sentigraph_client-side
cd sentigraph_client-side
```
...
here we changed this location through the `.bowerrc` file.  Putting it in the app folder makes
